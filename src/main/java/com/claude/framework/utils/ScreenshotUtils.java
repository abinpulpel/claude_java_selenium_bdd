...
/**
 * Captures PNG screenshots on demand (typically wired into a Cucumber
 * {@code Hooks} class's after-scenario failure branch) and returns the saved
 * path so it can be attached to the scenario and embedded in the Extent
 * Cucumber report.
 */
